  ...
  return (
    <header className="sticky top-0 z-40 bg-paper/90 backdrop-blur border-b border-teal-900/10">
      <Container className="flex items-center justify-between py-3.5">
        <a href="#" className="font-display text-lg font-semibold text-teal-900">
          {doctor.name}
        </a>
        ...
        <button
          ...
          aria-expanded={open}
          onClick={() => setOpen((v) => !v)}
          className="md:hidden inline-flex h-10 w-10 items-center justify-center rounded-full text-teal-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-teal-900"
        >
